public class Main {
    ...
    public static void main(String[] args) {
        ...
        в коде. А в методе deleteTaskById(int removeTask) и deleteTaskById(int removeTask) я вернул String.
        Возможно это неправильно, но я хотел оповестить человека на той стороне, как сработал метод)
