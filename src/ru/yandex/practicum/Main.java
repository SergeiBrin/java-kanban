...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /* Привет, Эркин :). Спасибо тебе за добрые слова в комментариях к прошлой версии работы.
        Так здорово, когда действительно сильный разработчик говорит, что индустрия нуждается в таких ребятах, как я :).

        Теперь по учёбе.
        Последний раз я отправлял работу на проверку неделю назад – и пропал. Но на самом деле я не пропал – я всегда
        бфл здесь. Просто после последней проверки я решил в первую очередь сосредоточиться на теории 6 спринта,
        а потом уже устранить замечания по финальной работе 5 спринта. В итоге так и сделал.

        Да, на данном этапе я всё еще не укладываюсь в мягкие дедлайны, но уже точно навёрстываю.
        К концу 8 спринта буду в графике (⌐■-■)

        Теперь по работе 5 спринта.
        Код двусвязного списка оптимизировал. Переменную size оставил только для того, чтобы смотреть его размер.
